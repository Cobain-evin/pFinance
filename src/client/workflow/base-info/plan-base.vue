      ...
      <ul class="info-form">
        ...
        <li class="readonly">
          <div class="info-rows">
            ...
            <div class="info-value">{{item.loan_balance || 0}}</div>
          </div>
        </li>
        <li class="readonly">
          <div class="info-rows">
        ...
        <li class="readonly">
          <div class="info-rows">
            ...
            <div class="info-value">{{Number(item.interest_rate)*100}}%</div>
          </div>
        </li>
        <li class="readonly">
          <div class="info-rows">
            <div class="info-name">预计综合费率</div>
            <div class="info-value">{{Number(item.syn_fee_rate)*100}}%</div>
          </div>
        </li>
        <li class="readonly">
          <div class="info-rows">
